  ...
  if (error || !article) {
    return (
      <div className="text-center py-12">
        ...
        <Link to="/legal-education" className="text-blue-600 hover:underline">
      ...
      <div className="card p-8 md:p-12">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 bg-blue-50 p-6 rounded-lg">
          <p className="text-sm text-gray-600">
            <strong>Note:</strong> This is a summary of key provisions. For the complete, official Constitution of Kenya, 
            please visit the{" "}
            <a 
